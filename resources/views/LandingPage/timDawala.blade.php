  ...
  <div class="container-fluid team pb-5">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            ...
            <p class="mb-0">Sekumpulan individu berdedikasi yang memiliki semangat tinggi dalam memberikan pelayanan inklusif dan ramah. Kami bekerja secara profesional dengan hati, memastikan setiap proses berjalan lancar, dan setiap kebutuhan disabilitas, orang berkebutuhan khusus, serta ODGJ terpenuhi dengan penuh kepedulian dan empati.
            </p>
        </div>
        <div class="row g-4">
