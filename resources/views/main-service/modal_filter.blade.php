                ...
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2 mb-md-0">
                            ...
                            <input type="date" class="form-control flatpickr-first-day-in-month" id="startDate" readonly>
                        </div>

                        <div class="col-md-4">
                            <label for="endDate" class="form-label text-start"><b>Tanggal Akhir</b></label>
                            <input type="date" class="form-control flatpickr-date" id="endDate" readonly>
                        </div>
