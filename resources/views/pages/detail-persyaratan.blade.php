    ...
    <div class="container-fluid layanan bg-light py-4">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p class="mb-0">Pembuatan pengajuan pembuatan e-KTP dan Kartu Keluarga ada beberapa syarat yang harus diisi
                    dan dipenuhi
                </p>
            </div>
            <div class="row g-4">
                <div class="col-md-6 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="layanan-item p-4 pt-0">
                        ...
                        <ul>
                            ...
                            <li>
                                Surat pengantar kelurahan/ desa (optional, tergantung kebijakan setempat) domisili tidak
                                punya data
                            ...
                            <li>
                                Untuk pengambilan e-KTP: Menunggu ketersediaan blangko, jika blangko kosong pemohon bisa
                                mendapatkan (Surat Ket) sebagai pengganti sementara e--KTP yang sah secara hukum.
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="layanan-item p-4 pt-0">
                        ...
                        <ul>
                            ...
                            <li>Surat ket pindah datang (jika penambahan anggota karna pindah domisili dari wilayah lain)
                            </li>
                        </ul>
                        <p class="mb-4">Penggantian KK hilang atau Rusak: - Surat Keterangan kehilangan dari kepolisian
                            (jika KK hilang) :
                        </p>
                        <ul>
