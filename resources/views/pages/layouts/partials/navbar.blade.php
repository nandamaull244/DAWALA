    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a href="#" class="navbar-brand p-0">
                <img src="{{ asset('assets') }}/img/logo.png" alt="Logo" style="width: 150px; height: 100px;">
            </a>
                ...
                <div class="navbar-nav mx-0 mx-lg-auto">
                    ...
                    <div class="nav-btn px-2">
                        <a href="{{ url('/auth/login') }}"
                            class="btn btn-primary rounded-pill py-2 px-4 ms-3 flex-shrink-0"> Masuk Dawala</a>
                        <a href="{{ url('/auth/register') }}"
                            class="btn btn-success rounded-pill py-2 px-4 ms-3 flex-shrink-0"> Daftar Dawala</a>
                    </div>
                </div>
            </div>
        </nav>
