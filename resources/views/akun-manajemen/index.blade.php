            ...
            <div class="card-body">
                <div class="row">
                    <div class="filter-container">
                        ...
                        <a href="{{ route('admin.akun-manajemen.create') }}" class="btn btn-primary add-new-btn">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="sticky-column action-icons">
                                        <span data-bs-toggle="modal" data-bs-target="#dataModalEditUser"
                                            style="cursor: pointer;">✏️</span>
                                        <span data-bs-toggle="modal" data-bs-target="#deleteModalUser"
                                            style="cursor: pointer;">🗑️</span>
                                    </td>
                                </tr>
                                <tr>
