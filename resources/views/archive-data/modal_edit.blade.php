        ...
        <div class="modal-content">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="kategori" name="kategori">
                                <option value="Disabilitas"
                                    {{ ($data->kategori ?? '') == 'Disabilitas' ? 'selected' : '' }}>Disabilitas
                                </option>
                                <option value="Tertantar"
                                    {{ ($data->kategori ?? '') == 'Tertantar' ? 'selected' : '' }}>Tertantar</option>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="tipe_layanan" name="tipe_layanan">
                                <option value="Persamaan KTP"
                                    {{ ($data->tipe_layanan ?? '') == 'Persamaan KTP' ? 'selected' : '' }}>Persamaan KTP
                                </option>
                                <option value="Pembuatan KK"
                                    {{ ($data->tipe_layanan ?? '') == 'Pembuatan KK' ? 'selected' : '' }}>Pembuatan KK
                                </option>
                                <!-- Add more options as needed -->
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="btn btn-sm btn-primary me-2"
                                    onclick="viewDocument('bukti_keterbatasan')">Lihat Foto</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="btn btn-sm btn-primary me-2"
                                    onclick="viewDocument('ktp')">Lihat Foto</a>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="btn btn-sm btn-primary me-2"
                                    onclick="viewDocument('kk')">Lihat Foto</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="btn btn-sm btn-primary me-2"
                                    onclick="viewDocument('formulir')">Lihat Formulir</a>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="status_pengerjaan"
                                name="status_pengerjaan" value="Telat H+1" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="status" class="form-label">STATUS</label>
                            <select class="form-select" id="status" name="status">
                                <option value="Completed"
                                    {{ ($data->status ?? '') == 'Completed' ? 'selected' : '' }}>Completed</option>
                                <option value="Processing"
                                    {{ ($data->status ?? '') == 'Processing' ? 'selected' : '' }}>Processing</option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#rejectModal"
                    onclick="$('#dataModalEdit').modal('hide')">Tolak Pengajuan</button>
