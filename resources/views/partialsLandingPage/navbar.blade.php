                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-0 mx-lg-auto">
                            ...
                            <div class="nav-btn px-2">
                                <a href="#" class="btn btn-primary rounded-pill py-2 px-4 ms-3 flex-shrink-0"> Masuk Dawala</a>
                                <a href="#" class="btn btn-success rounded-pill py-2 px-4 ms-3 flex-shrink-0"> Daftar Dawala</a>
                            </div>
                        </div>
                    </div>
