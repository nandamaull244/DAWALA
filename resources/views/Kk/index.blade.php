...
<div class="page-heading">
    <h3>Input layanan Kartu Keluarga</h3>
</div>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Silahkan mengisi form dibawah ini untuk mengajukan layanan Kartu
                        Keluarga</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Form Kartu Keluarga</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <button class="form-control btn btn-outline-primary" type="button" id="formFile"
                                    name="fotoKeterbatasan" data-bs-toggle="modal"
                                    data-bs-target="#formulirModal">Upload formulir</button>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if ("geolocation" in navigator) {
                ...
                alert(
                "Geolokasi tidak didukung oleh browser Anda. Silakan masukkan lokasi Anda secara manual.");
            }
        });
